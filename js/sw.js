...
// Bumped 2026-08-13: cup, grid start, resume, finish-time estimation,
// place-follows-time. A stale worker serving an old flow.js is the
// likeliest cause of "the fix didn't work" — it was the cause of the
// green-bots sighting too — so any change to the laws or the screens
// should bump this.
const CACHE = 'fast-fruit-v3';
